...
public class WaTool {
        ...
        public void showVpc(String prefix, String mode, String printMode, String profile) throws Exception {
                ...
                ElastiCacheClient cache = (ElastiCacheClient) Clients.getClientByServiceClass(Clients.ELASTICACHE,
                                profile);
                ...
                ElasticsearchClient es = (ElasticsearchClient) Clients.getClientByServiceClass(Clients.ELASTICSEARCH,
                                profile);
                        ...
                        while (iterVpcs.hasNext()) {
                                ...
                                for (Vpc vpc : vpcs) {
                                        ...
                                        Iterator<DescribeSubnetsResponse> iterSubnetsInVpc = ec2
                                                        .describeSubnetsPaginator(DescribeSubnetsRequest.builder()
                                                                        .filters(subnetF).build())
                                                        .iterator();
                                        while (iterSubnetsInVpc.hasNext()) {
                                                List<Subnet> subnets = iterSubnetsInVpc.next().subnets();
                                                subnetsInVpc.addAll(subnets);
                                        }
                                        Iterator<DescribeNetworkInterfacesResponse> iterEnis = ec2
                                        ...
                                        List<InternetGateway> igws = ec2
                                                        .describeInternetGateways(DescribeInternetGatewaysRequest
                                                                        .builder().filters(igwF).build())
                                                        .internetGateways();
                                        int igwCount = 0;
                                        for (InternetGateway igw : igws) {
                                                Speaker igwSpeaker = vSpeaker.clone();
                                                igwSpeaker.smartPrintResult(true,
                                                                Speaker.GW + " IGW-" + (++igwCount) + ": "
                                        ...
                                        List<VpnGateway> vgws = ec2.describeVpnGateways(
                                                        DescribeVpnGatewaysRequest.builder().filters(vgwF).build())
                                                        .vpnGateways();
                                        int vgwCount = 0;
                                        for (VpnGateway vgw : vgws) {
                                                Speaker vgwSpeaker = vSpeaker.clone();
                                                vgwSpeaker.smartPrintResult(true, Speaker.GW + " VGW-" + (++vgwCount)
                                                                + ": " + uec2.getNameTagValueEc2(vgw.tags()) + "|"
                                        ...
                                        while (iterRts.hasNext()) {
                                                ...
                                                for (RouteTable rt : rts) {
                                                        ...
                                                        for (RouteTableAssociation rta : rtas) {
                                                                if (rta.main()) {
                                                                        subnetToRoutetable.put("main",
                                                                                        rta.routeTableId());
                                                                } else {
                                                                        subnetToRoutetable.put(rta.subnetId(),
                                                                                        rta.routeTableId());
                                                                }
                                                        }
                                                        ...
                                                        if (mainRt != null) {
                                                                rtSpeaker.smartPrintResult(true, Speaker.RT + " RT-"
                                                                                + (++rtCount) + ": "
                                                                                + uec2.getNameTagValueEc2(rt.tags())
                                                                                + "|" + rt.routeTableId() + ", main:"
                                                                                + (mainRt.equals(rt.routeTableId())
                                                                                                ? "Yes"
                                                                                                : "No"));
                                                        } else {
                                                                rtSpeaker.smartPrintResult(true, Speaker.RT + " RT-"
                                                        ...
                                                        for (Route r : routes) {
                                                                ...
                                                                rtSpeaker.printResult(true, "#" + (++ruleCount) + ": "
                                                                                + (r.destinationCidrBlock() == null ? r
                                                                                                .destinationPrefixListId()
                                                                                                : r.destinationCidrBlock())
                                                                                + ", " + target + ", " + r.state()
                                                                                + ", propagated:"
                                                                                + (r.origin().equals(
                                                                                                RouteOrigin.ENABLE_VGW_ROUTE_PROPAGATION)
                                                                                                                ? "Yes"
                                                                                                                : "No"));
                                                        }
                                                }
                                        ...
                                        while (iterNacls.hasNext()) {
                                                ...
                                                for (NetworkAcl nacl : nacls) {
                                                        ...
                                                        naclSpeaker.smartPrintResult(true, Speaker.NACL + " NACL-"
                                                                        + (++naclCount) + ": "
                                                                        + uec2.decodeNacl(ec2, nacl) + ", default:"
                                                                        + (nacl.isDefault() ? "Yes" : "No"));
                                                        List<NetworkAclEntry> esy = nacl.entries();
                                                        for (NetworkAclEntry e : esy) {
                                                                naclSpeaker.printResult(true, (!e.egress()
                                                                                ? Speaker.INBOUND
                                                                                : Speaker.OUTBOUND) + " "
                                                                                + e.ruleNumber() + ", IcmpTypeCode:"
                                                                                + e.icmpTypeCode() + ", " + e.protocol()
                                                        ...
                                                        for (NetworkAclAssociation naa : naas) {
                                                                subnetIdToNaclId.put(naa.subnetId(),
                                                                                naa.networkAclId());
                                                        }
                                                }
                                        }
                                                ...
                                                for (SecurityGroup sg : sgs) {
                                                        ...
                                                        for (IpPermission p : inbounds) {
                                                                ...
                                                                for (UserIdGroupPair uigp : uigps) {
                                                                        sbu.append(uec2.sgIdToSgTagOrName(ec2,
                                                                                        uigp.groupId()) + ", ");
                                                                }
                                                                sgSpeaker.printResult(true, Speaker.INBOUND
                                                                                + " protocol: " + p.ipProtocol() + ", "
                                                                                + p.fromPort() + "-" + p.toPort()
                                                                                + ", Src: "
                                                                                + (p.ipRanges().size() == 0
                                                                                                ? sbu.toString()
                                                                                                : uec2.decodeIpv4Ranges(
                                                                                                                ec2,
                                                                                                                p.ipRanges())));
                                                        }
                                                        for (IpPermission p : outbounds) {
                                                                ...
                                                                sgSpeaker.printResult(true, Speaker.OUTBOUND
                                                                                + " protocol: " + p.ipProtocol() + ", "
                                                                                + p.fromPort() + "-" + p.toPort()
                                                                                + ", Dsc: "
                                                                                + (p.ipRanges().size() == 0
                                                ...
                                                for (software.amazon.awssdk.services.elasticloadbalancing.model.LoadBalancerDescription desc : lbs) {
                                                        ...
                                                        if (desc.vpcId().equals(vpc.vpcId())) {
                                                                ...
                                                                if (mode.equals(PLAIN)) {
                                                                        lbSpeaker.smartPrintResult(true, Speaker.ELB
                                                                                        + " ELB-" + (++elbCount)
                                                                                        + "-classic: "
                                                                                        + desc.loadBalancerName() + ", "
                                                                                        + desc.scheme() + ", "
                                                                                        + ", dns: " + desc.dnsName());
                                                                        lbSpeaker.smartPrintResult(true,
                                                                                        uec2.decodeSubnetsById(ec2,
                                                                                                        subnets));
                                                                        for (ListenerDescription ld : lds) {
                                                                                lbSpeaker.printResult(true, "listener: "
                                                                ...
                                                                lbSpeaker.printResult(true, uelb.getAttributes(elb,
                                                                                desc.loadBalancerName()));
                                                        }
                                                }
                                        }
                                        ...
                                        while (iterVpces.hasNext()) {
                                                ...
                                                for (VpcEndpoint p : vpces) {
                                                        ...
                                                        vpceSpeaker.smartPrintResult(true, Speaker.ENDPOINT
                                                                        + " VPC-Endpoint-" + (++vpceCount) + "-"
                                                                        + p.vpcEndpointTypeAsString() + ": "
                                                                        + uec2.getNameTagValueEc2(p.tags()) + "|"
                                                                        + p.vpcEndpointId() + ", to-svc:"
                                                                        + p.serviceName() + ", state:" + p.state());
                                                        if (!p.vpcEndpointType().equals(VpcEndpointType.GATEWAY)) {
                                                                vpceSpeaker.smartPrintResult(true, uec2
                                                                                .decodeSubnetsById(ec2, p.subnetIds()));
                                                                ...
                                                                if (mode.equals(PLAIN)) {
                                                                        for (NetworkInterface ni : enis) {
                                                                                ...
                                                                                niSpeaker.smartPrintResult(true, "eni-"
                                                                                                + (++iCount) + "-"
                                                                                                + ni.interfaceTypeAsString()
                                                                                                + ": "
                                                                                                + ni.availabilityZone()
                                                                                                + ", primary:{"
                                                                                                + ni.privateDnsName()
                                                                        ...
                                                                        for (NetworkInterface ni : enis) {
                                                                                ...
                                                                                niSpeaker.smartPrintResult(true, "eni-"
                                                                                                ...
                                                                                                + (ni.association() == null
                                                                                                                ? "n/a"
                                                                                                                : hp.redact(ni.association()
                                                                                                                                .publicDnsName()))
                                                                                                + ", "
                                                                                                + (ni.association() == null
                                                                                                                ? "n/a"
                                                                                                                : hp.redactIp(ni.association()
                                                                                                                                .publicIp()))
                                                                                                + "}");
                                                                                Speaker gSpeaker = niSpeaker.clone();
                                                                                gSpeaker.printResult(true,
                                                        ...
                                                        } else if (p.vpcEndpointType()
                                                                        .equals(VpcEndpointType.GATEWAY)) {
                                                                vpceSpeaker.smartPrintResult(true, "published-in: "
                                                                                + uec2.decodeRouteTablesById(ec2,
                                                                                                p.routeTableIds()));
                                                        }
                                                        if (mode.equals(PLAIN)) {
                                                                for (DnsEntry de : p.dnsEntries()) {
                                                                        vpceSpeaker.printResult(true,
                                                                                        "dns: " + de.dnsName());
                                                                }
                                                        } else {
                                                                for (DnsEntry de : p.dnsEntries()) {
                                                                        vpceSpeaker.printResult(true, "dns: "
                                                                                        + hp.redact(de.dnsName()));
                                                                }
                                                        }
                                                }
                                        }
                                        ...
                                        int vpcprCount = 0;
                                        Filter filterForVpcPeeringRequester = Filter.builder()
                                                        .name("requester-vpc-info.vpc-id").values(vpc.vpcId()).build();
                                        Filter filterForVpcPeeringAccepter = Filter.builder()
                                                        .name("accepter-vpc-info.vpc-id").values(vpc.vpcId()).build();
                                        Iterator<DescribeVpcPeeringConnectionsResponse> iterC1s = ec2
                                                        .describeVpcPeeringConnectionsPaginator(
                                                                        DescribeVpcPeeringConnectionsRequest.builder()
                                                                                        .filters(filterForVpcPeeringRequester)
                                                                                        .build())
                                                        .iterator();
                                        while (iterC1s.hasNext()) {
                                                ...
                                                for (VpcPeeringConnection c : c1s) {
                                                        ...
                                                        vpcprSpeaker.smartPrintResult(true, Speaker.VPCPEER
                                                                        + " PEER-Request-" + (++vpcprCount) + ": "
                                                                        + uec2.getNameTagValueEc2(c.tags()) + ", "
                                                                        + c.vpcPeeringConnectionId() + " to "
                                                                        + c.accepterVpcInfo().cidrBlock() + " of "
                                        ...
                                        Iterator<DescribeVpcPeeringConnectionsResponse> iterC2s = ec2
                                                        .describeVpcPeeringConnectionsPaginator(
                                                                        DescribeVpcPeeringConnectionsRequest.builder()
                                                                                        .filters(filterForVpcPeeringAccepter)
                                                                                        .build())
                                                        .iterator();
                                        while (iterC2s.hasNext()) {
                                                ...
                                                for (VpcPeeringConnection c : c2s) {
                                                        ...
                                                        vpcpaSpeaker.printResult(true, Speaker.VPCPEER + " PEER-Accept-"
                                                                        + (++vpcpaCount) + ": "
                                                                        + uec2.getNameTagValueEc2(c.tags()) + ", "
                                                                        + c.vpcPeeringConnectionId() + " from "
                                                                        + c.requesterVpcInfo().cidrBlock() + " of "
                                                                        + c.requesterVpcInfo().vpcId() + ", "
                                                                        + c.status().message());
                                                }
                                        }
                                        ...
                                        Iterator<ListClustersResponse> iterClusters = ecs
                                                        .listClustersPaginator(ListClustersRequest.builder().build())
                                                        .iterator();
                                                ...
                                                for (String cArn : clusterArns) {
                                                        software.amazon.awssdk.services.ecs.model.Cluster ec = ecs
                                                                        .describeClusters(DescribeClustersRequest
                                                                                        .builder().clusters(cArn)
                                                                                        .build())
                                                                        .clusters().get(0);
                                                        List<String> containerInstaneArns = ecs.listContainerInstances(
                                                                ...
                                                                for (ContainerInstance ci : cis) {
                                                                        for (Reservation r : ec2.describeInstances(
                                                                                        DescribeInstancesRequest
                                                                                                        .builder()
                                                                                                        .instanceIds(ci.ec2InstanceId())
                                                                                                        .build())
                                                                                        .reservations()) {
                                                                                for (Instance i : r.instances()) {
                                                                                        if (!i.state().name().equals(
                                                ...
                                                for (String cArn : clusterArns) {
                                                        ...
                                                        software.amazon.awssdk.services.ecs.model.Cluster ec = ecs
                                                                        .describeClusters(DescribeClustersRequest
                                                                                        ...
                                                                                        .build())
                                                                        .clusters().get(0);
                                                        ecsSpeaker.smartPrintResult(true, Speaker.ECS + " ECS-"
                                                                        + (++ecsCount) + ": " + ec.clusterName() + ", "
                                                                        + ec.status() + ", instances:"
                                                                        + ec.registeredContainerInstancesCount()
                                                                        + ", service:" + ec.activeServicesCount()
                                                                        + ", task(run/pending):"
                                                                        + ec.runningTasksCount() + "/"
                                                        ...
                                                        while (iterContainerInstanceArns.hasNext()) {
                                                                List<String> containerInstanceArns = iterContainerInstanceArns
                                                                                .next().containerInstanceArns();
                                                                        ...
                                                                        for (ContainerInstance ci : cis) {
                                                                                ...
                                                                                for (Reservation r : ec2
                                                                                        ...
                                                                                        for (Instance i : r
                                                                                                        .instances()) {
                                                                                                if (!i.state().name()
                                                                                                                .equals(InstanceStateName.TERMINATED)) {
                                                                                                        if (mode.equals(PLAIN)) {
                                                                                                                aSpeaker.smartPrintResult(
                                                                                                                                true,
                                                                                                                                "Name:{" + uec2.getNameTagValueEc2(
                                                                                                                                                i.tags())
                                                                                                                                                + "}, "
                                                                                                                                                + i.instanceId()
                                                                                                                                                + ", "
                                        ...
                                        for (DomainInfo di : dis) {
                                                ...
                                                ElasticsearchDomainStatus esde = es.describeElasticsearchDomain(
                                                                DescribeElasticsearchDomainRequest.builder()
                                                                                .domainName(di.domainName()).build())
                                                                .domainStatus();
                                                if (esde.vpcOptions().vpcId().equals(vpc.vpcId())) {
                                                        esSpeaker.smartPrintResult(true, Speaker.ES + " ES-Domain-"
                                                                        + (++esCount) + ": " + di.domainName() + ", "
                                                                        + esde.elasticsearchVersion()
                                                                        + ", master-count:"
                                                                        + esde.elasticsearchClusterConfig()
                                                                        ...
                                                                        + esde.elasticsearchClusterConfig()
                                                                                        .instanceType()
                                                                        + ", " + esde.ebsOptions().volumeType() + ", "
                                                                        + esde.ebsOptions().volumeSize() + "Gx"
                                                                        + esde.elasticsearchClusterConfig()
                                                                                        .instanceCount()
                                                                        + ", iops:" + esde.ebsOptions().iops());
                                                        for (String ename : esde.endpoints().keySet()) {
                                                                String endpoint = esde.endpoints().get(ename);
                                                                if (mode.equals(PLAIN)) {
                                                                        esSpeaker.printResult(true, "endpoint-" + ename
                                                                                        + ": " + endpoint);
                                                                } else {
                                                                        esSpeaker.printResult(true, "endpoint-" + ename
                                                                                        + ": " + hp.redact(endpoint));
                                                        ...
                                                        esSpeaker.printResult(true,
                                                                        "protected-by: " + uec2.decodeSgsByIds(ec2, esde
                                                                                        .vpcOptions()
                                                                                        .securityGroupIds()));
                                                        esSpeaker.printResult(true, uec2.decodeSubnetsById(ec2,
                                        ...
                                        Iterator<ListFunctionsResponse> iterFcs = lambda.listFunctionsPaginator()
                                                        .iterator();
                                        while (iterFcs.hasNext()) {
                                                ...
                                                for (FunctionConfiguration fc : fcs) {
                                                        ...
                                                        if (fc.vpcConfig() != null
                                                                        && fc.vpcConfig().vpcId().equals(vpc.vpcId())) {
                                                                if (mode.equals(PLAIN)) {
                                                                        fSpeaker.smartPrintResult(true, Speaker.LAMBDA
                                                                                        + " LAMBDA-" + (++lCount) + ": "
                                                                                        + fc.functionName() + ", "
                                                                                        + fc.functionArn() + ", "
                                                                                        + fc.version() + ", runtime:"
                                                                        ...
                                                                        fSpeaker.smartPrintResult(true, Speaker.LAMBDA
                                                                                        ...
                                                                                        + "m, ttl:" + fc.timeout()
                                                                                        + "s");
                                                                        fSpeaker.printResult(true, "role: "
                                                                                        + hp.redactArn(fc.role()));
                                                                }
                                                                fSpeaker.printResult(true, "protected-by: " + uec2
                                                                                .decodeSgsByIds(ec2, fc.vpcConfig()
                                                                                                .securityGroupIds()));
                                                                fSpeaker.printResult(true, uec2.decodeSubnetsById(ec2,
                                                                                fc.vpcConfig().subnetIds()));
                                                        }
                                                }
                                        }
                                        ...
                                        while (iterCacheSubnetGroups.hasNext()) {
                                                List<CacheSubnetGroup> cacheSubnetGroups = iterCacheSubnetGroups.next()
                                                                .cacheSubnetGroups();
                                                for (CacheSubnetGroup csg : cacheSubnetGroups) {
                                                        if (csg.vpcId().equals(vpc.vpcId())) {
                                                                cacheSubnetGroupNameToSubnetAzs.put(
                                                                                csg.cacheSubnetGroupName(),
                                                                                uec2.decodeCacheSubnets(ec2,
                                                                                                csg.subnets()));
                                                        }
                                                }
                                        }
                                        ...
                                        Iterator<DescribeCacheClustersResponse> iterCacheClusters = cache
                                                        .describeCacheClustersPaginator().iterator();
                                        while (iterCacheClusters.hasNext()) {
                                                List<CacheCluster> cacheClusters = iterCacheClusters.next()
                                                                .cacheClusters();
                                                for (CacheCluster cc : cacheClusters) {
                                                        Speaker ccSpeaker = vSpeaker.clone();
                                                        String engine = cc.engine();
                                                        if (engine.equals("redis") && cacheSubnetGroupNameToSubnetAzs
                                                                        .containsKey(cc.cacheSubnetGroupName())) {
                                                                cddGroupId = cc.replicationGroupId();
                                                                if (repGroupId == null
                                                                                || !cddGroupId.equals(repGroupId)) {
                                                                        ...
                                                                        ccSpeaker.smartPrintResult(true, Speaker.CACHE
                                                                                        + " REDIS-" + (++rdCount) + ": "
                                                                                ...
                                                                                if (mode.equals(PLAIN)) {
                                                                                        ccSpeaker.printResult(true,
                                                                                                        "endpoint: " + rg
                                                                                                                        ...
                                                                                                                        .address()
                                                                                                                        + ":"
                                                                                                                        + rg.configurationEndpoint()
                                                                                                                                        .port());
                                                                                } else {
                                                                                        ccSpeaker.printResult(true,
                                                                                                        "endpoint: " + hp
                                                                                                                        .redact(rg.configurationEndpoint()
                                                                                                                                        .address()
                                                                                                                                        + ":"
                                                                                                                                        + rg.configurationEndpoint()
                                                                                                                                                        .port()));
                                                                        ...
                                                                        ccSpeaker.printResult(true, "maintenance-utc: "
                                                                                        + cc.preferredMaintenanceWindow());
                                                                        ccSpeaker.printResult(true, "protected-by: "
                                                                                        + uec2.sgMemberShipsToSgTagOrName(
                                                                                                        ec2,
                                                                                                        cc.securityGroups()));
                                                                        ccSpeaker.printResult(true, cc
                                                                                        .cacheSubnetGroupName() + ": "
                                                                                        + cacheSubnetGroupNameToSubnetAzs
                                                                                                        .get(cc.cacheSubnetGroupName()));
                                                                } else {
                                                                        continue;
                                                                }
                                                        } else if (engine.equals("memcached")
                                                                        && cacheSubnetGroupNameToSubnetAzs.containsKey(
                                                                                        cc.cacheSubnetGroupName())) {
                                                                ccSpeaker.smartPrintResult(true, Speaker.CACHE
                                                                                + " MEMCACHED-" + (++mdCount) + ": "
                                                                                + cc.cacheClusterId() + ", "
                                                                                + cc.engine() + ", "
                                                                                ...
                                                                                + ", transitEnc:"
                                                                                + cc.transitEncryptionEnabled()
                                                                                + ", nodes: " + cc.numCacheNodes());
                                                                if (cc.configurationEndpoint() != null) {
                                                                        if (mode.equals(PLAIN)) {
                                                                                ccSpeaker.printResult(true, "endpoint: "
                                                                                                + cc.configurationEndpoint()
                                                                                                                .address()
                                                                                                + ":"
                                                                                                + cc.configurationEndpoint()
                                                                                                                .port());
                                                                                ...
                                                                                ccSpeaker.printResult(true, "endpoint: "
                                                                                                + hp.redact(cc.configurationEndpoint()
                                                                                                                .address()
                                                                                                                + ":"
                                                                                                                + cc.configurationEndpoint()
                                                                                                                                .port()));
                                                                ...
                                                                ccSpeaker.printResult(true, "maintenance-utc: "
                                                                                + cc.preferredMaintenanceWindow());
                                                                ccSpeaker.printResult(true, "protected-by: "
                                                                                + uec2.sgMemberShipsToSgTagOrName(ec2,
                                                                                                cc.securityGroups()));
                                                                ccSpeaker.printResult(true, cc.cacheSubnetGroupName()
                                                                                + ": "
                                                                                + cacheSubnetGroupNameToSubnetAzs.get(cc
                                                                                                .cacheSubnetGroupName()));
                                                        }
                                                }
                                        }
                                        ...
                                        int rdsCount = 0;
                                        Iterator<DescribeDbInstancesResponse> iterRdss = rds
                                                        .describeDBInstancesPaginator().iterator();
                                        while (iterRdss.hasNext()) {
                                                ...
                                                for (DBInstance instance : rdss) {
                                                        ...
                                                        String oneSgId = instance.vpcSecurityGroups().get(0)
                                                                        .vpcSecurityGroupId();
                                                        String oneVpcId = ec2.describeSecurityGroups(
                                                                        DescribeSecurityGroupsRequest.builder()
                                                                                        .groupIds(oneSgId).build())
                                                        ...
                                                        if (oneVpcId.equals(vpc.vpcId())) {
                                                                ...
                                                                if (mode.equals(PLAIN)) {
                                                                        rdsSpeaker.smartPrintResult(true, Speaker.DB
                                                                                        + " RDS-" + (++rdsCount) + ": "
                                                                ...
                                                                rdsSpeaker.printResult(true, "maintenance-utc: "
                                                                                + instance.preferredMaintenanceWindow()
                                                                                + ", backup-utc:"
                                                                                + instance.preferredBackupWindow());
                                                                rdsSpeaker.printResult(true, "protected-by: " + uec2
                                                                                .vpcSgMemberShipsToSgTagOrNameForRds(
                                                                                                ec2,
                                                                                                instance.vpcSecurityGroups()));
                                                                rdsSpeaker.printResult(true, "currently-at: "
                                                                                + instance.availabilityZone());
                                                                rdsSpeaker.printResult(true, instance.dbSubnetGroup()
                                                                                .dbSubnetGroupName() + ": "
                                                                                + uec2.decodeDbSubnetGroup(ec2, instance
                                                                                                .dbSubnetGroup()));
                                                        }
                                                }
                                        }
                                        ...
                                        int rsCount = 0;
                                        Iterator<DescribeClustersResponse> iterRss = rs.describeClustersPaginator()
                                                        .iterator();
                                        while (iterRss.hasNext()) {
                                                ...
                                                for (Cluster c : rss) {
                                                        ...
                                                        if (c.vpcId().equals(vpc.vpcId())) {
                                                                if (mode.equals(PLAIN)) {
                                                                        rsSpeaker.smartPrintResult(true, Speaker.DB
                                                                                        + " REDSHIFT-" + (++rsCount)
                                                                                        + ": " + c.clusterIdentifier()
                                                                                        + ", " + c.numberOfNodes()
                                                                                        + " of " + c.nodeType()
                                                                                        ...
                                                                                        + c.masterUsername()
                                                                                        + ", auto-snap-retention:"
                                                                                        + c.automatedSnapshotRetentionPeriod()
                                                                                        + ", status:"
                                                                                        + c.clusterStatus()
                                                                                        + ", m-status: "
                                                                                        + (c.modifyStatus() == null
                                                                ...
                                                                if (c.endpoint() != null) {
                                                                        if (mode.equals(PLAIN)) {
                                                                                rsSpeaker.printResult(true, "endpoint: "
                                                                                                + c.endpoint().address()
                                                                                                + ":"
                                                                                                + c.endpoint().port()
                                                                                                + "/" + c.dbName());
                                                                ...
                                                                rsSpeaker.printResult(true, "protected-by: " + uec2
                                                                                .vpcSgMemberShipsToSgTagOrNameForRedshift(
                                                                                                ec2,
                                                                                                c.vpcSecurityGroups()));
                                                                rsSpeaker.printResult(true, "currently-at: "
                                                                                + c.availabilityZone());
                                                                rsSpeaker.printResult(true, c.clusterSubnetGroupName()
                                                                                + ": "
                                                                                + uec2.decodeRedshiftClusterSubnetGroupName(
                                                                                                ec2, rs,
                                                                                                c.clusterSubnetGroupName()));
                                                        }
                                                }
                                        }
                                        ...
                                        Iterator<MetricAlarm> iterAlarms = cw
                                        ...
                                        int asgCount = 0;
                                        Iterator<AutoScalingGroup> iterAsg = asg.describeAutoScalingGroupsPaginator()
                                                        .autoScalingGroups().iterator();
                                        ...
                                        while (iterAsg.hasNext()) {
                                                ...
                                                if (vpc.vpcId().equals(ec2
                                                                .describeSubnets(DescribeSubnetsRequest.builder()
                                                                                .subnetIds(subnets[0]).build())
                                                                .subnets().get(0).vpcId())) {
                                                        asSpeaker.smartPrintResult(true, Speaker.ASG + " ASG-"
                                                                        + (++asgCount) + ": "
                                                                        + as.autoScalingGroupName() + ", lc:"
                                                                        + as.launchConfigurationName() + ", status:"
                                                                        + as.status() + ", hc-type:"
                                                                        + as.healthCheckType());
                                                        asSpeaker.printResult(true, "az:" + as.availabilityZones());
                                                        List<software.amazon.awssdk.services.autoscaling.model.Instance> instances = as
                                                                        .instances();
                                                        asSpeaker.printResult(true,
                                                                        "desired:" + as.desiredCapacity() + ", max:"
                                                                                        + as.maxSize() + ", min:"
                                                                                        + as.minSize() + ", registered:"
                                                                                        + instances.size());
                                        ...
                                        for (Subnet s : subnetsInVpc) {
                                                Filter subnetIdFilter = Filter.builder().name("subnet-id")
                                                                .values(s.subnetId()).build();
                                                Speaker sSpeaker = vSpeaker.clone();
                                                sSpeaker.smartPrintTitle("SUBNET-" + (++sc) + ": "
                                                                + uec2.decodeSubnetById(ec2, s.subnetId()) + " RT: "
                                                                + uec2.rtIdToRtTagOrId(ec2, (subnetToRoutetable
                                                                                .get(s.subnetId()) == null
                                                                                                ? subnetToRoutetable
                                                                                                                .get("main")
                                                                                                : subnetToRoutetable
                                                                                                                .get(s.subnetId())))
                                                                + ", NACL: " + uec2.naclIdToNaclTagOrId(ec2,
                                                                                subnetIdToNaclId.get(s.subnetId())));
                                                // Nat Gateway
                                                sSpeaker.printTitle("NAT Gateway:");
                                                for (NatGateway nat : ec2.describeNatGateways(DescribeNatGatewaysRequest
                                                                .builder().filter(vpcF, subnetIdFilter).build())
                                                                .natGateways()) {
                                                        Speaker ngSpeaker = sSpeaker.clone();
                                                        ngSpeaker.smartPrintResult(true, Speaker.GW + " NATGW-"
                                                                        + (++natCount) + ": "
                                                                        + uec2.getNameTagValueEc2(nat.tags()) + ", "
                                                                        + nat.natGatewayId() + ", " + nat.state()
                                                ...
                                                while (iterEmrs.hasNext()) {
                                                        ...
                                                        for (ClusterSummary cs : css) {
                                                                if (!cs.status().state()
                                                                                .equals(ClusterState.TERMINATED)) {
                                                                        software.amazon.awssdk.services.emr.model.Cluster c = emr
                                                                                        .describeCluster(
                                                                                                        DescribeClusterRequest
                                                                                                                        ...
                                                                                                                        .build())
                                                                                        .cluster();
                                                                        String ec2SnId = c.ec2InstanceAttributes()
                                                                                        .ec2SubnetId();
                                                                        if (ec2SnId.equals(s.subnetId())) {
                                                                                ...
                                                                                System.out.println();
                                                                                if (mode.equals(PLAIN)) {
                                                                                        emrSpeaker.printResult(true,
                                                                                                        "master: " + c.masterPublicDnsName());
                                                                                } else {
                                                                                        emrSpeaker.printResult(true,
                                                                                                        "master: " + hp.redact(
                                                                                                                        c.masterPublicDnsName()));
                                                                                }
                                                                                emrSpeaker.printResult(true,
                                                                                                "service-role: " + c
                                                                                                                .serviceRole());
                                                ...
                                                Iterator<DescribeInstancesResponse> iterReservations = ec2
                                                                .describeInstancesPaginator(DescribeInstancesRequest
                                                                                .builder().filters(vpcInstanceFilter)
                                                                                .build())
                                                                .iterator();
                                                                        ...
                                                                        if (!i.state().name().equals(
                                                                                ...
                                                                                if (mode.equals(PLAIN)) {
                                                                                        eSpeaker.smartPrintResult(true,
                                                                                                        sSpeaker.getIconForEC2InstanceType(
                                                                                                                        i.instanceId(),
                                                                                                                        instanceId2Ec2Type)
                                                                                                                        + "  EC2-"
                                                                                                                        + (++ec2Count)
                                                                                                                        + ": Name:{"
                                                                                                                        + uec2.getNameTagValueEc2(
                                                                                                                                        i.tags())
                                                                                                                        + "}, "
                                                                                                                        + i.instanceId()
                                                                                                                        + ", "
                                                                                        ...
                                                                                        eSpeaker.printResult(true,
                                                                                                        "role: " + (i.iamInstanceProfile() == null
                                                                                                                        ? "n/a"
                                                                                                                        : hp.redactArn(i.iamInstanceProfile()
                                                                                                                                        .arn())));
                                                                                        eSpeaker.printResult(true,
                                                                                                        "key: " + hp.redact(
                                                                                                                        i.keyName()));
                                                                                }
                                                                                Filter ebsFilter = Filter.builder()
                                                                                                                        ...
                                                                                                                        "eni-" + eni.attachment()
                                                                                                                                        ...
                                                                                                                                        + (eni.association() == null
                                                                                                                                                        ...
                                                                                                                                                        : eni.association()
                                                                                                                                                                        .publicIp())
                                                                                                                                        + "}");
                                                                                                        eniSpeaker.printResult(
                                                                                                                        true,
                                                                                                                        "protected-by: " + uec2
                                                                                                                                        .groupIdentifierToSgTagOrName(
                                                                                                                                                        ec2,
                                                                                                                                                        eni.groups()));
                                                                                                        for (NetworkInterfacePrivateIpAddress addr : eni
                                                                                                                        .privateIpAddresses()) {
                                                                                                                eniSpeaker.printResult(
                                                                                                                                true,
                                                                                                                                "address-association: "
