            ...
            while (iterVpcs.hasNext()) {
                ...
                for (Vpc vpc : vpcs) {
                    ...
                    Iterator<DescribeSubnetsResponse> iterSubnetsInVpc = ec2
                            .describeSubnetsPaginator(DescribeSubnetsRequest.builder().filters(subnetF).build())
                            .iterator();
                    ...
                    vSpeaker.smartPrintTitle("VPC: " + vpcName + "|" + vpc.vpcId() + ", " + vpc.cidrBlock()
                    ...
                    List<VpnGateway> vgws = ec2
                            .describeVpnGateways(DescribeVpnGatewaysRequest.builder().filters(vgwF).build())
                            .vpnGateways();
                    int vgwCount = 0;
                        ...
                        for (RouteTable rt : rts) {
                            ...
                            if (mainRt != null) {
                                ...
                                rtSpeaker.smartPrintResult(true, Speaker.RT + " RT-" + (++rtCount) + ": "
                                        + uec2.getNameTagValueEc2(rt.tags()) + "|" + rt.routeTableId());
                            }
                    ...
                    while (iterNacls.hasNext()) {
                        ...
                        for (NetworkAcl nacl : nacls) {
                            ...
                            for (NetworkAclEntry e : esy) {
                                naclSpeaker.printResult(true, (!e.egress() ? Speaker.INBOUND : Speaker.OUTBOUND) + " "
                                        + e.ruleNumber() + ", IcmpTypeCode:" + e.icmpTypeCode() + ", " + e.protocol()
                    ...
                    Iterator<DescribeSecurityGroupsResponse> iterSgs = ec2.describeSecurityGroupsPaginator(
                            DescribeSecurityGroupsRequest.builder().filters(sgF).build()).iterator();
                    ...
                    while (iterLbv2s.hasNext()) {
                        ...
                        for (LoadBalancer l2 : lbv2s) {
                            ...
                            if (l2.vpcId().equals(vpc.vpcId())) {
                                ...
                                List<Listener> ls = elbv2.describeListeners(DescribeListenersRequest.builder()
                                        .loadBalancerArn(l2.loadBalancerArn()).build()).listeners();
                                ...
                                lbv2Speaker.printResult(true,
                                        uelbv2.getAttributes(elbv2, l2.loadBalancerArn(), 3, 100));
                            }
                        }
                    }
                    ...
                    while (iterVpces.hasNext()) {
                        ...
                        for (VpcEndpoint p : vpces) {
                            ...
                            vpceSpeaker.smartPrintResult(true, Speaker.ENDPOINT + " VPC-Endpoint-" + (++vpceCount) + "-"
                                    + p.vpcEndpointTypeAsString() + ": " + uec2.getNameTagValueEc2(p.tags()) + "|"
                                    + p.vpcEndpointId() + ", to-svc:" + p.serviceName() + ", state:" + p.state());
                                ...
                                if (mode.equals(PLAIN)) {
                                    for (NetworkInterface ni : enis) {
                                        ...
                                        niSpeaker.smartPrintResult(true, "eni-" + (++iCount) + "-"
                                                + ni.interfaceTypeAsString() + ": " + ni.availabilityZone()
                                                + ", primary:{" + ni.privateDnsName() + ", " + ni.privateIpAddress()
                                                + ", "
                    ...
                    Iterator<DescribeVpcPeeringConnectionsResponse> iterC1s = ec2
                            .describeVpcPeeringConnectionsPaginator(DescribeVpcPeeringConnectionsRequest.builder()
                                    .filters(filterForVpcPeeringRequester).build())
                            .iterator();
                        ...
                        for (VpcPeeringConnection c : c1s) {
                            ...
                            vpcprSpeaker.smartPrintResult(true,
                                    Speaker.VPCPEER + " PEER-Request-" + (++vpcprCount) + ": "
                                            ...
                                            + " to " + c.accepterVpcInfo().cidrBlock() + " of "
                    ...
                    Iterator<DescribeVpcPeeringConnectionsResponse> iterC2s = ec2
                            .describeVpcPeeringConnectionsPaginator(DescribeVpcPeeringConnectionsRequest.builder()
                                    .filters(filterForVpcPeeringAccepter).build())
                            .iterator();
                    ...
                    while (iterClusters.hasNext()) {
                        ...
                        for (String cArn : clusterArns) {
                            software.amazon.awssdk.services.ecs.model.Cluster ec = ecs
                                    .describeClusters(DescribeClustersRequest.builder().clusters(cArn).build())
                                    .clusters().get(0);
                    ...
                    while (iterClustersRound2.hasNext()) {
                        ...
                        for (String cArn : clusterArns) {
                            ...
                            ecsSpeaker.smartPrintResult(true,
                                    "ECS-" + (++ecsCount) + ": " + ec.clusterName() + ", " + ec.status()
                            ...
                            while (iterContainerInstanceArns.hasNext()) {
                                ...
                                for (String instanceArn : containerInstanceArns) {
                                    ...
                                    for (ContainerInstance ci : cis) {
                                        ...
                                        for (Reservation r : ec2.describeInstances(DescribeInstancesRequest.builder()
                                                .instanceIds(ci.ec2InstanceId()).build()).reservations()) {
                                            for (Instance i : r.instances()) {
                                                if (!i.state().name().equals(InstanceStateName.TERMINATED)) {
                                                    if (mode.equals(PLAIN)) {
                                                        aSpeaker.smartPrintResult(true,
                                                                "Name:{" + uec2.getNameTagValueEc2(i.tags()) + "}, "
                                                                        ...
                                                                        + (i.sriovNetSupport() == null ? "n/a"
                                                                                : i.sriovNetSupport())
                                                                        + ", ena:" + i.enaSupport() + ", "
                                                                        + i.state().name() + ", " + i.privateIpAddress()
                        ...
                        for (CacheCluster cc : cacheClusters) {
                            ...
                            if (engine.equals("redis")
                                ...
                                if (repGroupId == null || !cddGroupId.equals(repGroupId)) {
                                    ...
                                    ccSpeaker.smartPrintResult(true, "REDIS-" + (++rdCount) + ": "
                    ...
                    Iterator<MetricAlarm> iterAlarms = cw
                            .describeAlarmsPaginator(DescribeAlarmsRequest.builder().build()).metricAlarms().iterator();
                    MetricAlarm ma = null;
                    ...
                    for (Subnet s : subnetsInVpc) {
                        ...
                        for (NatGateway nat : ec2
                            ...
                            ngSpeaker.smartPrintResult(true, Speaker.GW + " NATGW-" + (++natCount) + ": "
                                    + uec2.getNameTagValueEc2(nat.tags()) + ", " + nat.natGatewayId() + ", "
                                    + nat.state() + ", provisioned-bandwidth:"
                            ...
                            for (ClusterSummary cs : css) {
                                if (!cs.status().state().equals(ClusterState.TERMINATED)) {
                                    software.amazon.awssdk.services.emr.model.Cluster c = emr
                                            .describeCluster(
                                                    DescribeClusterRequest.builder().clusterId(cs.id()).build())
                                            .cluster();
                                    ...
                                    if (ec2SnId.equals(s.subnetId())) {
                                        ...
                                        if (mode.equals(PLAIN)) {
                                            ...
                                            emrSpeaker.printResult(true,
                                                    "master: " + hp.redact(c.masterPublicDnsName()));
                                        }
                        ...
                        Iterator<DescribeInstancesResponse> iterReservations = ec2
                                .describeInstancesPaginator(
                                        DescribeInstancesRequest.builder().filters(vpcInstanceFilter).build())
                                .iterator();
                            ...
                            for (Reservation r : ress) {
                                for (Instance i : r.instances()) {
                                    ...
                                    if (!i.state().name().equals(InstanceStateName.TERMINATED)
                                        ...
                                        subnetEc2Count++;
                                        if (mode.equals(PLAIN)) {
                                            eSpeaker.smartPrintResult(true, sSpeaker.getIconForEC2InstanceType(
                                                    i.instanceId(), instanceId2Ec2Type) + "  EC2-" + (++ec2Count)
                                                    + ": Name:{" + uec2.getNameTagValueEc2(i.tags()) + "}, "
                                            ...
                                            eSpeaker.smartPrintResult(true,
                                                    sSpeaker.getIconForEC2InstanceType(i.instanceId(),
                                            ...
                                            eSpeaker.printResult(true,
                                                    "role: " + (i.iamInstanceProfile() == null ? "n/a"
                                        ...
                                        for (NetworkInterface eni : enisInVpc) {
                                            ...
                                            if (eni.attachment() != null && eni.attachment().instanceId() != null
                                                ...
                                                if (mode.equals(PLAIN)) {
                                                    ...
                                                    for (NetworkInterfacePrivateIpAddress addr : eni
                                                            .privateIpAddresses()) {
                                                        eniSpeaker.printResult(true, "address-association: "
